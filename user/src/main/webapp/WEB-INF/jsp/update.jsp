          ...
          <form action="/updateuser/${users.id}" method="post" >
            ...
            <div class="formbold-input-flex">
              ...
              <div>
                ...
                <input  class="formbold-form-input" type="text" name="name" value="${users.empName}" id="name" />
              </div>

              <div>
                <label for="age" class="formbold-form-label"> Age </label>
                <input class="formbold-form-input" type="text" name="age" id="age" value="${users.empAge}" />
              </div>
            ...
            <div class="formbold-input-flex">
              <div>
                ...
                <input class="formbold-form-input" type="email" name="empGmail" id="empGmail" value="${users.empAge }"  />
              </div>
              <div>
                <label for="phone" class="formbold-form-label"> Destination</label>
                <input class="formbold-form-input" type="text" name="empDestination" id="empDestination" value="${users.empDestination }"   />
              </div>
            </div>
            ...
            <div class="formbold-input-flex">
              <div>
                ...
                <input class="formbold-form-input" type="number" name="empSalary" id="empSalary" value="${empSalary}"  />
              </div>
              <div>
                <label for="area" class="formbold-form-label"> Branch </label>
                <input class="formbold-form-input" type="text" name="empBranch" id="empBranch" value="${empBranch }"  />
              </div>
            </div>
      
        
            <div class="btn-flex">
                <button class="formbold-btn submit" type="submit"><a href="/getuser">Update</a> </button>
            </div>
